...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data() {
        return {
            ...
            loading: false,
            formValidate: {
                method: this.$route.query.task_name,
                format: '',
                data: ''
            },
            ruleValidate: {
    ...
    methods: {
        ...
        returnList: function () {
            this.$router.push('/taskManagement?page_no=' + this.$route.query.page_no);
        },
        submit: function (name) {
            this.$refs[name].validate(valid => {
                ...
                let reset = () => {
                    this.formValidate = {};
                    this.formValidate.method = this.$route.query.task_name;
                    this.loading = false;
                    this.show = false;
                };
                let error = error => {
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__client_task__ = __webpack_require__(178);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_inputPush__ = __webpack_require__(204);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_sendPush__ = __webpack_require__(205);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getDataFromInput: function (data) {
            ...
            this.sendShow = true;
            this.taskData = { taskName: data.taskName, taskArgs: data.taskArgs, argsString: JSON.stringify(data.taskArgs) };
        },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_vm._m(0), _vm._v(" "), _c('div', {
    ...
    model: {
      value: (this.taskData.argsString),
      callback: function($$v) {
        _vm.$set(this.taskData, "argsString", $$v)
      },
      expression: "this.taskData.argsString"
    }
  })], 1)], 1), _vm._v(" "), _c('div', {
    staticStyle: {
      "float": "right"
